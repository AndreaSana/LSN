...
class TSP
{
    public: 
        ...
        TSP(const int& n_generation, const int& n_travels, vector<Position> pos_cities);        
        // Constructor with number of travels and cities
        TSP(const int& n_generation, const int& n_travels, vector<City> cities);                
        // Destructor
        ~TSP(){};                                                                               
        ...
        void Evolution(const int& n_gen, const string& namefile);                     
