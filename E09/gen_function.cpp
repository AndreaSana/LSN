...
vector<Travel> New_generation(Random& rn, const vector<Travel>& travels, const string& namefile)
{
    double prob_pair_perm = 0.2;       // Probability of pair permutation
    double prob_shift = 0.2;            // Probability of shift
    double prob_block_perm = 0.2;      // Probability of block permutation
    double prob_inv = 0.2;             // Probability of inversion 
