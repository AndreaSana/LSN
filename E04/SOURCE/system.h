...
class System 
{
	...
	public: 	// Function declarations
		...
		void initialize(string path_input, string path_output, double temp = 0.);	// Initialize system properties
		...
		void averages(int blk, string path_output);     							// Compute averages of properties
