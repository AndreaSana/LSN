...
{ 
  ...
  ifstream Primes(path_input + "Primes");
  Primes >> p1 >> p2 ;
  Primes.close();
  int seed[4]; // Read the seed of the RNG
  ifstream Seed(path_input + "seed.in");
...
{
  ofstream coutf;
  coutf.open(path_output + "CONFIG/velocities.in");
  if(coutf.is_open())
	{
    for(int i=0; i<_npart; i++)
		{
...
void System :: averages(int blk, string path_output)
{
