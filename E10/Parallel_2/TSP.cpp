...
TSP :: TSP(const int& n_generation, const int& n_travels, vector<Position> pos_cities, const int& row, const int& size, const vector<double>& temp)
{
...
TSP :: TSP(const int& n_generation, const int& n_travels, vector<City> cities, const int& row, const int& size, const vector<double>& temp)
{
    _current_gen = 0;                       // Set number of current generation
    _n_generation = n_generation;           // Set number of generations
    _n_travels = n_travels;                 // Set number of travels each generation
...
// Get temperature
double TSP :: Get_temperature(const int& index) const
{
    return _temp[index];
}
