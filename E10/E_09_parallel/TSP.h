...
class TSP
{
    public: 
        ...
        TSP(const int& n_generation, const int& n_travels, vector<Position> pos_cities, const int& row, const int& size, const double& temp);        
        // Constructor with number of travels and cities
        TSP(const int& n_generation, const int& n_travels, vector<City> cities, const int& row, const int& size, const double& temp);                
        // Destructor
        ~TSP(){};                                                                               
        ...
        void Evolution(const string& name);                                    
